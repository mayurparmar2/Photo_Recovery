...
import com.demo.example.databinding.ItemDocsRecoveredBinding;
...
@Metadata(d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010!\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u00002\f\u0012\b\u0012\u00060\u0002R\u00020\u00000\u0001:\u0001\u001dB)\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\t¢\u0006\u0002\u0010\nJ\u0006\u0010\u000b\u001a\u00020\fJ\b\u0010\r\u001a\u00020\u000eH\u0016J\u0010\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0002J\u001c\u0010\u0013\u001a\u00020\f2\n\u0010\u0014\u001a\u00060\u0002R\u00020\u00002\u0006\u0010\u0015\u001a\u00020\u000eH\u0016J\u001c\u0010\u0016\u001a\u00060\u0002R\u00020\u00002\u0006\u0010\u0017\u001a\u00020\u00182\u0006\u0010\u0019\u001a\u00020\u000eH\u0016J\u0006\u0010\u001a\u001a\u00020\fJ\u0010\u0010\u001b\u001a\u00020\f2\u0006\u0010\u001c\u001a\u00020\u0007H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\tX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001e"}, d2 = {"Lcom/gcs/recovery/videos/files/photo_recovery/adapter/RecoveredDocsAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lcom/gcs/recovery/videos/files/photo_recovery/adapter/RecoveredDocsAdapter$DocumentViewHolder;", "context", "Landroid/content/Context;", "docList", "", "Ljava/io/File;", "selectedItems", "", "(Landroid/content/Context;Ljava/util/List;Ljava/util/List;)V", "deselectAll", "", "getItemCount", "", "isFileAlreadyRecovered", "", "filePath", "", "onBindViewHolder", "holder", "position", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "selectAll", "toggleSelection", ShareInternalUtility.STAGING_PARAM, "DocumentViewHolder", "app_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes2.dex */
public final class RecoveredDocsAdapter extends RecyclerView.Adapter<DocumentViewHolder> {
    private final Context context;
    private final List<File> docList;
    private final List<File> selectedItems;

    /* JADX WARN: Multi-variable type inference failed */
    public RecoveredDocsAdapter(Context context, List<? extends File> docList, List<File> selectedItems) {
    ...
    public void onBindViewHolder(DocumentViewHolder holder, int position) {
        ...
        final File file = this.docList.get(position);
        holder.getBinding().docName.setText(file.getName());
        holder.getBinding().imageView.setImageResource(Utils.INSTANCE.getIconForFileType(file));
        holder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.gcs.recovery.videos.files.photo_recovery.adapter.RecoveredDocsAdapter$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                RecoveredDocsAdapter.onBindViewHolder$lambda$1(RecoveredDocsAdapter.this, file, view);
            }
        });
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.gcs.recovery.videos.files.photo_recovery.adapter.RecoveredDocsAdapter$$ExternalSyntheticLambda1
            @Override // android.view.View.OnLongClickListener
            public final boolean onLongClick(View view) {
                boolean onBindViewHolder$lambda$2;
                onBindViewHolder$lambda$2 = RecoveredDocsAdapter.onBindViewHolder$lambda$2(RecoveredDocsAdapter.this, file, view);
    ...
    public static final void onBindViewHolder$lambda$1(RecoveredDocsAdapter this$0, File docFile, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(docFile, "$docFile");
        if (!this$0.selectedItems.isEmpty()) {
            this$0.toggleSelection(docFile);
            return;
        }
        String absolutePath = docFile.getAbsolutePath();
        Intent intent = new Intent(this$0.context, (Class<?>) ViewDocActivity.class);
        intent.putExtra("FILE_TYPE", "doc");
        intent.putExtra("DOC_PATH", absolutePath);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean onBindViewHolder$lambda$2(RecoveredDocsAdapter this$0, File docFile, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(docFile, "$docFile");
        this$0.toggleSelection(docFile);
        return true;
    ...
    private final boolean isFileAlreadyRecovered(String filePath) {
        ...
        if (file.exists() && file.isFile()) {
            ...
            if (Intrinsics.areEqual(parentFile != null ? parentFile.getName() : null, "Documents")) {
                return true;
            }
        }
        return false;
    ...
    public final void selectAll() {
        ...
        this.selectedItems.addAll(this.docList);
        notifyDataSetChanged();
    }
