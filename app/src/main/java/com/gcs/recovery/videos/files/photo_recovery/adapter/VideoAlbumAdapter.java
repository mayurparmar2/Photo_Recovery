...
public final class VideoAlbumAdapter extends RecyclerView.Adapter<AlbumViewHolder> {
    ...
    public VideoAlbumAdapter(List<AlbumModel> albumList, Function1<? super AlbumModel, Unit> onItemClickListener) {
    ...
    /* compiled from: VideoAlbumAdapter.kt */
    @Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J$\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r2\u0012\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\r\u0012\u0004\u0012\u00020\u000b0\u000fH\u0007R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lcom/gcs/recovery/videos/files/photo_recovery/adapter/VideoAlbumAdapter$AlbumViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "itemView", "Landroid/view/View;", "(Landroid/view/View;)V", "ivThumbnail", "Landroid/widget/ImageView;", "tvAlbumName", "Landroid/widget/TextView;", "tvItemCount", "bind", "", "album", "Lcom/gcs/recovery/videos/files/photo_recovery/model/AlbumModel;", "onItemClickListener", "Lkotlin/Function1;", "app_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class AlbumViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void bind(final AlbumModel album, final Function1<? super AlbumModel, Unit> onItemClickListener) {
            ...
            this.tvItemCount.setText(album.getItemCount() + " Videos");
            Glide.with(this.itemView.getContext()).load(album.getThumbnail()).placeholder(R.drawable.ic_video_placeholder).into(this.ivThumbnail);
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.gcs.recovery.videos.files.photo_recovery.adapter.VideoAlbumAdapter$AlbumViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    VideoAlbumAdapter.AlbumViewHolder.bind$lambda$0(Function1.this, album, view);
                }
            });
        }
